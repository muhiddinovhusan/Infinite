...
<div className='flex justify-between mb-3'  >
    <div className='mt-11'>
        <h1 className='text-5xl mb-11 font-medium'>Infinity <br /> Клубный дом</h1>
        <button className='bg-[#E1AF93] hover:border-black hover:border w-48 max-sm:w-1/2 font-semibold text-[#ffffff] text-sm h-11'>Позвонить </button>
...
<button className='w-12 h-12  flex justify-center items-center rounded-full border-black border'>
<img src={vector} className='h-3 filter invert' alt="" />
</button>
<button className='w-12 h-12 flex justify-center items-center text-xl rounded-full border-black border'>
...
<p className='w-[472px] max-sm:w-[354px]  max-sm:text-[15px] mb-6 font-normal text-base md:hidden'> Дом имеет свой приватный, закрытый двор, с несколькими зонами отдыха для взрослых и детей. Отдельно предусмотрено помещение для консьержа и охраны. Из окон квартир открывается вид на эксклюзивный ландшафтный двор-парк общей площадью более 1 Га, с прогулочными аллеями, водными объектами и летним кинотеатром.</p>
