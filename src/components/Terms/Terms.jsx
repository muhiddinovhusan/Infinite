...
<div className='mb-10'>
    <h1 className='text-4xl font-medium mb-5'>Условия покупки</h1>
    <p className='w-[600px] text-[#858585] max-sm:w-[350px]'>Процесс покупки недвижимости в нашем агентстве разработан таким образом,
...
<div className='flex justify-between max-md:flex-col mb-4 border-b border-b-[#ebebeb] pb-8'>
    ...
    <div className='w-[505px] max-sm:w-[360px] md:pl-10'>
