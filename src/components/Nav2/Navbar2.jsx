...
const Navbar2 = () => {
  return (
    <div  className='mb-40' style={{
        ...
        <ul className='flex items-center text-sm  overflow-x-auto max-md:whitespace-nowrap w-full max-md:gap-14 md:justify-center h-20 border-b mb-40 border-b-[#ededed] gap-[75px] '>
